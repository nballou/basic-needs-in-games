...
<!--
NOTE: this document is the manuscript body only. It reads every computed
object from the targets pipeline (preprocessing / imputation / modelling /
studyb) via tar_load(); it fits no models itself. Model diagnostics live in
modelling.qmd; the appendix and sensitivity analyses live in supplement.qmd.
-->
...
tar_load(c(
  surveys, intake, hourly_telemetry, daily_telemetry, activity_categories,
  dat, dat_desc, m_imputations,
  h1_pooled, h1mod, h2_pooled, h2mod, h3_pooled, h3mod,
  pws_m1, pws_m2, pws_wide, pws_n_players, pws_n_sessions
))
